        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Converta JSON em interfaces TypeScript limpas. Suporta objetos aninhados, arrays e inferência básica de tipos.
            </p>
          </header>
          ...
          <nav className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#arrays-nested" className="text-blue-600 dark:text-blue-400 hover:underline">Arrays e Objetos Aninhados</a></li>
          ...
          <article className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <ul className="space-y-2 text-green-700 dark:text-green-300 text-sm">
                    <li>• Gera interfaces TS a partir do JSON</li>
                    <li>• Conversão em tempo real</li>
                    <li>• Interfaces filhas para objetos aninhados</li>
                  </ul>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  ...
                  <ul className="space-y-2 text-yellow-700 dark:text-yellow-300 text-sm">
                    ...
                    <li>• Array no topo é suportado (baseado no primeiro item)</li>
                    <li>• Arrays heterogêneos exigem ajuste manual</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section id="type-mapping" className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    <li>• array → T[] (baseado no primeiro elemento)</li>
                    <li>• object → interface filha nomeada</li>
                    <li>• objeto aninhado → interface separada + referência</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section id="arrays-nested" className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Arrays e Objetos Aninhados</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
...
{`{
  "values": [1, "two", true]
                    ...
                    <p className="mt-2 text-xs text-yellow-700 dark:text-yellow-300">Tipos mistos; ajuste para união ou normalize os dados.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section id="tips" className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    <li>• Valide o JSON antes de converter</li>
                    <li>• Renomeie interfaces para nomes de domínio</li>
                    <li>• Adicione modificadores opcionais (?) quando fizer sentido</li>
                  </ul>
                </div>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <li>• Sem detecção automática de opcionais/uniões</li>
                    <li>• Esquemas complexos podem exigir ajustes</li>
                  </ul>
                </div>
              </div>
            </section>
