...
const META: WikiMetaInput = {
  ...
  title: 'Validação e Schema JSON: Guia Prático',
  description: 'Valide JSON com JSON Schema: como escrever schemas, quais palavras-chave importam, como os erros são reportados e onde a validação se encaixa.',
  keywords: 'validação JSON,JSON Schema,validação dados,qualidade dados,validação formato JSON',
  socialTitle: 'Validação e Schema JSON',
  section: 'Validação',
