...
const META: WikiMetaInput = {
  ...
  description: '十篇 JSON 指南：语法与数据类型、Schema 校验、REST API 设计、解析性能、转义、注释，以及代码生成。',
...
export default function WikiChinesePage() {
  const articles = [
    ...
    },
    {
      ...
      description: '一份文件该用哪个格式，以及互相转换时会发生什么变化',
      category: 'conversion',
      categoryName: '格式转换',
      icon: GlobeAltIcon,
    ...
    },
    {
      ...
      title: '嵌套 JSON 转 CSV',
      description: '嵌套结构如何摊平成列、数组会变成什么，以及转换在哪里会丢数据',
      category: 'conversion',
      categoryName: '格式转换',
      icon: DocumentTextIcon,
      href: '/wiki/cn/json-to-csv-nested/',
      tags: ['CSV', '摊平', '表格'],
      readTime: '10 分钟',
      difficulty: 'intermediate',
    },
    {
      id: 'json-escaping',
      title: 'JSON 转义',
      description: '为什么 JSON 字符串套 JSON 字符串会让反斜杠翻倍，以及怎么把数据还原出来',
      category: 'foundation',
      categoryName: '基础知识',
      icon: DocumentTextIcon,
    ...
    },
    {
      id: 'json-comments',
      title: 'JSON 能写注释吗',
      description: '不能。写了会报什么错、JSON5 和 JSONC 改了什么，以及四种变通办法',
      category: 'foundation',
      categoryName: '基础知识',
      icon: AcademicCapIcon,
