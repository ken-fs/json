...
export const metadata: Metadata = {
  title: { absolute: "Terms of Use | JSON.how" },
  description:
    "The terms for using JSON.how: a free, client-side developer tool provided as-is, with no warranty and no data collected from what you paste.",
  keywords: ["json.how terms of use", "terms of service", "developer tool terms", "as-is"],
  alternates: { canonical: "/terms/" },
  openGraph: {
    title: "Terms of Use | JSON.how",
    description: "The terms for using a free, client-side JSON tool provided as-is.",
    url: `${SITE_URL}/terms/`,
    siteName: "JSON.how",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "JSON.how Terms of Use" }],
  },
  twitter: {
        ...
        <main className="flex-1 px-4 py-10 sm:px-6 lg:px-9 lg:py-14">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-base leading-7 text-[#4a4d54] sm:text-lg sm:leading-8">
              JSON.how is a free set of browser-based tools for reading, checking, and converting
              JSON. Using the site means you accept the terms below. They are short because a
              static tool does not need long ones.
            </p>

            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">Use of the tools</h2>
            ...
            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">No warranty</h2>
              <p className="mt-4 text-sm leading-7 text-[#4a4d54] sm:text-base">
            ...
            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">Limitation of liability</h2>
              <p className="mt-4 text-sm leading-7 text-[#4a4d54] sm:text-base">
                To the extent the law allows, JSON.how is not liable for any loss or damage arising
            ...
            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">Intellectual property</h2>
              <p className="mt-4 text-sm leading-7 text-[#4a4d54] sm:text-base">
                The name, design, and written guides on JSON.how belong to the project. The output
            ...
            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">Ads and third parties</h2>
              <p className="mt-4 text-sm leading-7 text-[#4a4d54] sm:text-base">
            ...
            <section className="mt-12">
              <h2 className="text-xl font-extrabold tracking-[-0.03em]">Changes</h2>
              <p className="mt-4 text-sm leading-7 text-[#4a4d54] sm:text-base">
